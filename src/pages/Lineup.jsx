  ...
  return (
    <>
      ...
      <div className='w-full h-100 bg-red-300 absolute z-10' style={{
        ...
        <Navbar />
        <div className='absolute z-12 w-full h-100 flex flex-col items-center mt-40'>
          <div className='flex gap-2'>
            <h1 className='text-5xl mt-2 text-white bebas-font'>Featuring</h1>
            <span className='flex'>
              <img className='w-65 h-17' src="bg-text.svg" alt="" />
              <h1 className='absolute text-5xl bebas-font text-white mt-2 ml-3'>Extraordinary</h1>
            </span>
            <h1 className='text-5xl text-white bebas-font mt-2'>line up</h1>
          </div>
          <p className='font-[500] text-[#b6b6b6] text-lg'>In Alphabetical Order</p>
        </div>
      </div>
      ...
      {selectedCard && (
        <div className="fixed inset-0  bg-opacity-10 overflow-y-auto scrollbar-hide  flex justify-center h-auto z-70">
          <div className="bg-black text-white rounded-3xl h-[130vh]  w-[60vw] mb-20 mt-10 relative ">
            <button
              className="absolute top-2 right-3 text-5xl text-gray-600 hover:text-black"
            ...
            <h2 className="text-4xl font-bold bebas-font absolute mt-90 ml-10 text-white   mb-2">{selectedCard.text}</h2>
            </div>
